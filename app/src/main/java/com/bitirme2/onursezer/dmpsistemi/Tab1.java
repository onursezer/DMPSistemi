...
/*        hotel_nombre = (TextView) getView().findViewById(R.id.);
...
*/
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FirebaseDatabase.getInstance().getReference("Sohpet/"+classID).push().setValue(new ChatMessage(emojiconEditText.getText().toString(),
                        nameUser));
